                    ...
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                ...
                                alt="background"
                                className="absolute inset-x-0 top-56 -z-20 hidden lg:top-32 dark:block opacity-60"
                                width="3276"
                                height="4095"
                            />
                        </AnimatedGroup>
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    ...
                                    <h1
                                        className="mt-8 max-w-5xl mx-auto text-balance text-4xl md:text-5xl lg:mt-16 xl:text-6xl font-bold tracking-tight leading-tight">
                                        Proposal: Development, Hosting & Managed Operations of the New GhIPSS Corporate Website
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-3xl text-balance text-lg text-muted-foreground leading-relaxed">
                                        A modern, secure, content-rich digital presence that positions GhIPSS as Ghana's national payments infrastructure provider—built for clarity, trust, stakeholder engagement, and long-term governance.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="outline"
                                        className="h-10.5 rounded-xl px-6 border-zinc-700">
                                        <Link href="#">
                                            <span className="text-nowrap">Download Full Proposal (PDF)</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex">
                                <span className="mx-auto h-5 w-fit font-bold text-xl">BoG</span>
                            </div>

                            <div className="flex">
                                <span className="mx-auto h-4 w-fit font-bold text-lg">GCB</span>
                            </div>
                            <div className="flex">
                                <span className="mx-auto h-4 w-fit font-bold text-lg">Ecobank</span>
                            </div>
                            <div className="flex">
                                <span className="mx-auto h-5 w-fit font-bold text-lg">Stanbic</span>
                            </div>
                            <div className="flex">
                                <span className="mx-auto h-5 w-fit font-bold text-sm">Fidelity</span>
                            </div>
                            <div className="flex">
                                <span className="mx-auto h-4 w-fit font-bold text-lg">CalBank</span>
                            </div>
                            <div className="flex">
                                <span className="mx-auto h-7 w-fit font-bold text-xl">Zenith</span>
                            </div>

                            <div className="flex">
                                <span className="mx-auto h-6 w-fit font-bold text-lg">Absa</span>
                            </div>
                        </div>
                    </div>
                </section>
...
const menuItems = [
    { name: 'Understanding', href: '#understanding' },
    { name: 'Technology', href: '#technology' },
    { name: 'Timeline', href: '#project-plan' },
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            <Link
                                ...
                                <img src="/ananseum-icon.png" alt="Ananseum" className="h-8 w-auto" />
                            </Link>
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                {/* Header buttons removed per TOR requirements */}
                            </div>
                        </div>
                    </div>
                </div>
